    ...
    <div class="con">
        <el-collapse v-model="activeName">
            <el-collapse-item name="1">
                <template slot="title">
                    <span style="font-weight:bold;font-size:14px;color:#fff;margin-left:20px">2020年加油站分布</span>
                </template>
                <div class="item">
            ...
            <el-collapse-item name="2">
                <template slot="title">
                    <span style="font-weight:bold;font-size:14px;color:#fff;margin-left:20px">2019年加油站分布</span>
                </template>
                <div class="item">
...
export default {
    ...
    methods: {
        initECharts() {
            ...
            let option_vb = {
                title: { text: '加油站个数' ,top:20,left:'5%'},
                xAxis: {
                    type: 'category',
