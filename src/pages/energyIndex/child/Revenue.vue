<template>
    ...
    <div class="con">
        <el-collapse v-model="activeName">
            <el-collapse-item title="2020年营收" name="1">
                <div class="item">
                    <div class="big" id="RevenueA"></div>
                    <div class="medium" id="RevenueB"></div>
                    <div class="small" id="RevenueC"></div>
                </div>
            </el-collapse-item>
            <el-collapse-item title="2019年营收" name="2">
                <div class="item">
                    <div class="big" id="RevenueD"></div>
                    <div class="medium" id="RevenueE"></div>
                    <div class="small" id="RevenueF"></div>
                </div>
            </el-collapse-item>
