    ...
    <div class="con">
        <el-collapse v-model="activeName">
            <el-collapse-item name="1">
                <template slot="title">
                    <span style="font-weight:bold;font-size:14px;color:#fff;margin-left:20px">2020年回款率</span>
                </template>
                <div class="item">
                    ...
                    <div style="width: 48.5%;margin-bottom: 0;height: 600px" id="CollectionRateE">
                        <my-table :columns="columns" height="580px" :multiple="false" :border="false" :data="tableData"></my-table>
                    </div>
                </div>
            </el-collapse-item>
            <el-collapse-item name="2">
                <template slot="title">
                    <span style="font-weight:bold;font-size:14px;color:#fff;margin-left:20px">2019年回款率</span>
                </template>
                <div class="item">
