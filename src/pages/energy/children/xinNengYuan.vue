<template>
    <div style="width: 100%;height: 100%;">
        <my-collapse-base ref="collapse" :collapseData="collapseData" nav-bar-show @selectionChange="selectionChange"></my-collapse-base>
    </div>
</template>
...
export default {
                                    ...
                                    EChartsItem: [
                                        {
                                            ...
                                            option: {
                                                ...
                                                series: [
                                                    {
                                                        data: [522, 932, 521, 734, 540, 530, 630, 721, 943, 176, 621, 212],
                                                        type: "line",
                                                    },
                                                ],
                                            },
    ...
    methods: {
        ...
        obtainAxios(name, year, years) {
            let data = [];
            let id = "";
            this.$axios.get("/api/sundry/fuwuqucaiwu", { params: { nianfen: year, type: years, plateName: "能源板块" } }).then((v) => {
                data = v.data.data;
                let mm = [];
