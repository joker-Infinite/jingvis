<template>
  <div style="width: 100%; height: 100%;">
    <my-collapse-base nav-bar-show ref="collapse" :collapseData="collapseData" @searchQuery="searchQuery">
    </my-collapse-base>
  </div>
</template>
<script>
										...
										EChartsItem: [
											{
												...
												option: {
													...
													series: [
														...
														{
															name: '利润',
															data: [13212, 24332, 30541, 33234, 42120, 36550, 53760, 25421, 54543, 57546, 49451, 35442],
															type: 'line',
															itemStyle: {
																color: 'green'
															}
														...
														{
															name: '成本费用利润率',
															data: [32322, 43222, 31221, 53234, 14340, 15450, 16520, 37621, 58753, 55446, 43221, 37642],
															type: 'line',
															itemStyle: {
																color: 'yellow'
															}
