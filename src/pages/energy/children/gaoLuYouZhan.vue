          ...
          collapseItem: [
            ...
            },
            {
              ...
              EChartsBox: [
                {
                  title:
                    '<span style="float: left">预算项目列表</span><span style="float: right;text-shadow:none;height: 100%;text-align: right;padding-right: 20px">2020年 执行金额:160亿元 预算金额:200亿元 总执行度:80%</span>',
                  input: true,
                  select: true,
