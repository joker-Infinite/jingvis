                    ...
                    <el-row class="body" :gutter="24">
                        <el-col :span="6" v-for="item in baseData" :key="item">
                            <el-row :gutter="24">
                                ...
                                <el-col :span="12" style="text-align:center">{{ item.value }}</el-col>
                            </el-row>
                        </el-col>
                    </el-row>
                </el-collapse-item>
                                                ...
                                                series: [
                                                    {
                                                        name: "a",
                                                        type: "line",
                                                        data: [321, 432, 123, 543, 256, 123, 400, 265, 654, 352, 326, 765],
                                                        barWidth: "16px",
                                                        itemStyle: {
                                                            normal: {
                                                                color: "#38A0FF",
                                                    ...
                                                    },
                                                    {
                                                        name: "b",
                                                        type: "line",
                                                        data: [586, 560, 500, 365, 256, 362, 400, 265, 333, 352, 254, 360],
                                                        barWidth: "16px",
                                                        itemStyle: {
                                                            normal: {
                                                                color: "#76c15c",
...
.box /deep/ .el-collapse > .el-collapse-item > .el-collapse-item__wrap > .el-collapse-item__content {
    padding-bottom: 0;
}
</style>
