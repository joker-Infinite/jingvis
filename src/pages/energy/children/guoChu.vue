	  ...
	  data() {
											  ...
											  option: {
												  ...
												  tooltip: {
													  ...
													  formatter: function (params) {
														  return params[0].name + '月' + ':' + "<br>" + params[0].data / 10000 + '万元'
													  },
													  axisPointer: {
														  // 坐标轴指示器，坐标轴触发有效
		...
		methods: {
			...
			obtainAxios(name, year, years) {
				let data = [];
				let id = '';
				this.$axios.get('/api/sundry/fuwuqucaiwu',
