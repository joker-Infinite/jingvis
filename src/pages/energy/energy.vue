<template>
    <div style="width: 100%;height: 100%;">
        <my-collapse-base ref="collapse" :collapseData="collapseData"
                          @selectionChange="selectionChange"></my-collapse-base>
    </div>
</template>
            ...
            return {
                collapseData: [
                    ...
                    },
                    {
                        id: "c",
                        name: "批零差价",
                        icon: require("../../assets/energy/1.png"),
                        iconActive: require("../../assets/energy/2.png"),
                        collapseItem: [
                            {
                                id: "c_2020",
                    ...
                    },
                    {
                        id: "rateofreturn",
                        name: "回款率",
                        icon: require("../../assets/energy/6.png"),
                        iconActive: require("../../assets/energy/5.png"),
                        collapseItem: [
                            {
                    ...
                    },
                    {
                        id: "profit",
                        name: "加油站分布",
                        icon: require("../../assets/energy/3.png"),
                        iconActive: require("../../assets/energy/4.png"),
                        collapseItem: [
                            {
                                id: "profit_2020",
                                        ...
                                        EChartsItem: [
                                            {
                                                ...
                                                tableData: [
                                                    {a: 'xx加油站', b: '22', c: '32', d: '12', e: '32', f: '43', g: '12'},
                                                    {a: 'xx加油站', b: '22', c: '32', d: '12', e: '32', f: '43', g: '12'},
                                                    {a: 'xx加油站', b: '22', c: '32', d: '12', e: '32', f: '43', g: '12'},
                                                    {a: 'xx加油站', b: '22', c: '32', d: '12', e: '32', f: '43', g: '12'},
                                                ],
