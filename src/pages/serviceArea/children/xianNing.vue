                  ...
                  cItem.EChartsBox.forEach((sItem, sIndex) => {
                    if (sIndex == 0) {
                      ...
                      if (mm.length !== 0) {
                        ...
                        sItem.EChartsItem[0].option.yAxis[1].min = parseInt(
                          Math.min(...arr) - 5
                        );
                        sItem.EChartsItem[0].option.yAxis[1].max = parseInt(
                          Math.max(...arr) + 5
                        );
    ...
    async TableDatas(pageNum, pageSize) {
      this.$axios
        .get("/api/jtService/serve_list", {
          params: {
            companyId: "c9050eb22c7f14b33acdab4077879dcc3",
            pageNum: pageNum,
            pageSize: pageSize,
