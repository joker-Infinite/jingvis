<template>
    <div class="nav">
              ...
              'el-icon-view': ix === 5
                ...
                <div class="content_l">
                    <div class="form_box">
                                    ...
                                    <el-checkbox-group v-model="formStatus.gas" @change="gasType(formStatus.gas)">
                                        ...
                                        <el-checkbox :value="3" label="汽油" class="checkbox_select" :disabled="closed">
                                            <template slot="default">
                                                汽油
                                                <el-select v-model="formStatus.gasoline" :class="{ disabled: gasolineDisabled }"
                        ...
                        <div style="width: 100%;height: 100%" v-if="it.content === '基础信息'">
                            <el-tabs v-model="activeNameTabs" @tab-click="tabsClick" type="card">
                                <el-tab-pane label="东区" name="first">
                                    <el-form class="baseForm" :model="formBasis" label-width="125px" style="width: 62%;float:left">
                        ...
                        <el-form class="common" :model="formSpecialty" label-width="110px" v-if="it.content === '特产信息'">
                            <el-col :span="12">
                            ...
                            <el-col :span="24">
                                <el-form-item label="描述：">
                                    <el-input type="textarea" resize="none" :rows="6" show-word-limit :maxlength="500" v-model="formSpecialty.remark">
                                    </el-input>
                                </el-form-item>
                            </el-col>
                        </el-form>
                        <el-form class="common" :model="formFeatures" label-width="110px" v-if="it.content === '特色信息'">
                            <el-col :span="12">
                                <el-form-item label="名称：">
                            ...
                            <el-col :span="24">
                                <el-form-item label="描述：">
                                    <el-input type="textarea" resize="none" :rows="6" show-word-limit :maxlength="500" v-model="formFeatures.remark">
                                    </el-input>
                                </el-form-item>
                            </el-col>
                        </el-form>
        ...
        <div class="right">
            <div class="navBar">
                <p v-for="(it, ix) in tabData" @click="goto(ix)" :class="{ active: isActive === ix }" :key="ix">
