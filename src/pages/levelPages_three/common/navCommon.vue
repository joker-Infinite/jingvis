                ...
                <div class="content_l">
                    <div class="form_box">
                        ...
                        <div style="width: 100%;height: 100%" v-if="it.content === '基础信息'">
                            <el-tabs class="tabs" v-model="activeNameTabs" @tab-click="tabsClick" type="card">
                                <el-tab-pane label="东区" name="first">
                                    <el-form class="baseForm" :model="formBasis" label-width="125px"
        ...
        > .el-collapse-item__content {
            ...
            .content_l {
                ...
                .form_box {
                    ...
                    .tabs /deep/ .el-tabs__header > .el-tabs__nav-wrap > .el-tabs__nav-scroll > .el-tabs__nav > .is-active {
                        background: #409EFF;
                        color: white;
                        font-size: 18px;
                        font-weight: 700;
                    ...
                    .tabs /deep/ .el-tabs__header > .el-tabs__nav-wrap > .el-tabs__nav-scroll > .el-tabs__nav > .el-tabs__item {
                        font-size: 18px;
                        font-weight: 700;
                    }
                }
