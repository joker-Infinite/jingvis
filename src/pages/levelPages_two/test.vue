<template>
    <div class="body">
        ...
        <div class="left" >
            ...
            <div style="text-align:right;padding-right:20px"><i @click="isCollapse=!isCollapse,isshow(!isCollapse)" style="font-size:25px" :class="{'el-icon-s-fold':!isCollapse,'el-icon-s-unfold':isCollapse}"></i></div>
            
            <el-menu :style="{width:!isCollapse&&'200px'}" default-active="2" @select="selectMenu" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose"
                :collapse="isCollapse">
                ...
                <el-submenu index="2">
                    <template slot="title">
                        ...
                        <el-menu-item index="1-1" v-loading.fullscreen.lock="fullscreenLoading">黄冈分公司</el-menu-item>
