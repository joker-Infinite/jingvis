...
export default {
    ...
    methods: {
        EchartsLeft() {
            let EchartsLefts = this.$echarts.init(
            ...
            EchartsLefts.setOption(option, true);
        },
        EchartsRight() {
            ...
            EchartsRight.setOption(option, true);
        },
        isechartsShow(data) {
...
.leftin:hover > .information {
    display: block;
}
.rightin:hover > .information {
    display: block;
}
</style>
