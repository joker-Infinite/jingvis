...
export default {
    ...
    data() {
        return {
            ...
            height: 0,
            anchorData: [
                { name: '营收', icon: require('../../../assets/business/icon_1-1.png'), iconHover: require('../../../assets/business/icon_1-2.png') },
                { name: '利润', icon: require('../../../assets/business/icon_2-1.png'), iconHover: require('../../../assets/business/icon_2-2.png') },
                { name: '成本', icon: require('../../../assets/business/icon_3-1.png'), iconHover: require('../../../assets/business/icon_3-2.png') },
                { name: '数量', icon: require('../../../assets/business/icon_4-1.png'), iconHover: require('../../../assets/business/icon_4-2.png') },
                { name: '结构', icon: require('../../../assets/business/icon_5-1.png'), iconHover: require('../../../assets/business/icon_5-2.png') },
                { name: '回款率', icon: require('../../../assets/business/icon_6-1.png'), iconHover: require('../../../assets/business/icon_6-2.png') }],
            widths: '',
        }
    },
