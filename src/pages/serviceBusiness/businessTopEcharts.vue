<template>
    <div class="content" v-if="businessId.id" :style="{ height: isshow ? '800px' : '400px' }">
        <div class="top">
            <div class="left" :style="{ width: businessId.show ? '40%' : '60%' }"
                @mouseover="mouseHover('A', businessId.id[0], businessId.data.left,businessId.data.xAis,businessId.name)">
                <!-- {{businessId.id[0]}} -->
            ...
            <div class="center" :style="{ width: businessId.show ? '32%' : '40%' }"
                @mouseover="mouseHover('B', businessId.id[1], businessId.data.center,businessId.data.centerxAis,businessId.name)">
                <!-- {{businessId.id[1]}} -->
...
export default {
    ...
    methods: {
        ...
        mouseHover(v, id, data, xAis, name) {
            this.isvalue = v;
            this.required.id = id;
        ...
        EchartsBottom() {
            ...
            let option = {
                ...
                tooltip: {
                    trigger: "axis",
                    formatter: function (val) {
                        return val[0].name + ':' + val[0].value + "元" + '<br>' + val[1].value + "元" + "<br>" + "实际占比:" + val[2].value + '%';
                    }
                },
                grid: {
                    left: "3%",
