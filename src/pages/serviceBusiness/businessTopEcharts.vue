<template>
    <div class="content" :style="{ height: isshow ? '800px' : '400px' }">
        <div v-if="businessId.id" class="top">
            ...
            <div class="right right1" @mouseover="mouseHover('C', businessId.id[2], businessId.data.left)">
        ...
        <div class="bottom" v-if="isshow">
            <div class="bottomLeft" @mouseover="mouseHover('D', businessId.echartsBottoms, businessId.data.left)">
