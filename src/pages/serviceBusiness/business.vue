  ...
  <div class="business" :style="{ width: widths }">
    <div class="businessMargin">
      ...
      <div class="anchor ">
        ...
        <div
          :class="{ anchorHover: isHover == inde }"
          @click="goto(inde)"
          v-for="(item, inde) of anchorData"
          :key="inde"
        >
...
export default {
  ...
  methods: {
    ...
    isaxios(url, nianfen, id, i, is) {
      console.log(this.businessIdData[i]);
      this.$axios
        .get("/api" + url, {
  ...
  mounted() {
    ...
    //  // 营收2020
    this.isaxios(
      "/jtService/list_jtservice_revenue_month",
      "2020-01-01",
      "businessId",
      0,
      "bar"
    ...
    this.isaxios(
      "/jtService/list_jtservice_revenue_format",
      "2020-01-01",
      "businessId",
      0,
      "pie"
    ...
    // let time = setTimeout(() => {
    //     for (let i = 1; i <= 6; i++) {
    //         console.log(document.getElementById("box" + i).offsetTop)
    //         if (i <= 3) {
    ...
    //     switch (i) {
    //         case 0:
    //             this.$refs.scrollDiv.businessId = this.businessId[i]
    //             this.$refs.scrollDiv.isechartsShow(this.businessId[i])
    //             i++;
    //             break;
    //         case 1:
    //             this.$refs.scrollDiv.businessId2 = this.businessId[i]
    //             this.$refs.scrollDiv.isechartsShow(this.businessId[i])
    //             i++;
    //             break;
    //         case 2:
    //             this.$refs.scrollDiv.businessId3 = this.businessId[i]
    //             this.$refs.scrollDiv.isechartsShow(this.businessId[i])
    //             i++;
    //             break;
    //         case 3:
    //             this.$refs.scrollDiv.businessId4 = this.businessId[i]
    //             this.$refs.scrollDiv.isechartsShow(this.businessId[i])
    //             i++;
    //             break;
    //         case 4:
    //             this.$refs.scrollDiv.businessId5 = this.businessId[i]
    //             this.$refs.scrollDiv.isechartsShow(this.businessId[i])
    //             i++;
    //             break;
    //         case 5:
    //             this.$refs.scrollDiv.businessId6 = this.businessId[i]
    //             this.$refs.scrollDiv.isechartsShow(this.businessId[i])
    //             i++;
    //             break;
    //         case 6:
    //             this.$refs.scrollBottom.businessId = this.businessId[i]
    //             this.$refs.scrollBottom.isechartsShow(this.businessId[i])
    //             i++;
    //             break;
    //         case 7:
    //             this.$refs.scrollBottom.businessId1 = this.businessId[i]
    //             this.$refs.scrollBottom.isechartsShow(this.businessId[i])
    //             i++;
    //             break;
    //         case 8:
    //             this.$refs.scrollBottom.businessId2 = this.businessId[i]
    //             this.$refs.scrollBottom.isechartsShow(this.businessId[i])
    //             i++;
    //             break;
    //         case 9:
    //             this.$refs.scrollBottom.businessId3 = this.businessId[i]
    //             this.$refs.scrollBottom.isechartsShow(this.businessId[i])
    //             i++;
    //             break;
    //         case 10:
    //             this.$refs.scrollBottom.businessId4 = this.businessId[i]
    //             this.$refs.scrollBottom.isechartsShow1(this.businessId[i])
    //             i++;
    //             break;
    //         case 11:
    //             this.$refs.scrollBottom.businessId5 = this.businessId[i]
    //             this.$refs.scrollBottom.isechartsShow1(this.businessId[i])
    //             i++;
    //             break;
