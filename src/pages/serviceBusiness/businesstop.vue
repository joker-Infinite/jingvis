  ...
  <div class="businesstop">
    ...
    <el-collapse id="box1" v-model="revenue" @change="handleChange">
      <el-collapse-item name="1">
        <template slot="title">
          ...
          >
          <!-- <div class="titleList">
            <span @click.stop="iconList(1)">图标</span>
            <span @click.stop="iconList(2)">列表</span>
            <span @click.stop="iconList(3)">导出excel</span>
          </div> -->
        </template>
        <businessTopEcharts :businessId="businessId"></businessTopEcharts>
      </el-collapse-item>
      <el-collapse-item name="2">
        ...
        <businessTopEcharts :businessId="businessId2"></businessTopEcharts>
      </el-collapse-item>
    ...
    <el-collapse id="box2" v-model="profit" @change="handleChange">
      <el-collapse-item name="1">
        ...
        <businessTopEcharts :businessId="businessId3"></businessTopEcharts>
      </el-collapse-item>
      <el-collapse-item name="2">
        <template slot="title">
          <span
        ...
        <businessTopEcharts :businessId="businessId4"></businessTopEcharts>
      </el-collapse-item>
      <el-collapse-item name="3">
        <template slot="title">
          <span
