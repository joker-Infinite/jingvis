              ...
              >
                ...
                >
                  ...
                  <div
                    :style="{
                      width:
                        sit.istime && sit.isselect && sit.isinput ? '' : '100%'
                    }"
                  ...
                  >
                    {{
                      processingTitle(
                        sit.title,
                        "processingTitle^" + item.id + "^" + cix + "^" + six
                      )
                    }}
                  </div>
                  <div
                  ...
                  >
                    ...
                    <el-select
                      v-if="
                        sit.selectNum &&
                          (sit.selectNum === 3 || sit.selectNum === 2)
                      "
                    >
                      <el-option
                ...
                <div
                  v-if="sit.button"
                  style="width:98%;margin-top:10px;text-align:right"
                >
                  <el-select
                    @change="selectData()"
                    v-model="value"
                  ...
                  <el-button style="margin-left:10px" @click="AddClick(sit)"
                    >添加</el-button
                  >
                </div>
                <div
                ...
                >
                  ...
                  >
                    <div>
                      {{ wit.serviceNamemin ? wit.serviceNamemin : "" }} 最高:{{
                  ...
                  <div v-if="wit.isbar" class="switchover">
                    <el-button size="mini" @click="switchoverClick(1)"
                      >供应商</el-button
                    >
                    <el-button size="mini" @click="switchoverClick(2)"
                      >业态</el-button
                    >
                  </div>
                  <div
