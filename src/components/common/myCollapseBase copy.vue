        ...
        <div class="navigation">
            <div class="navBar">
                ...
                >
                    <img
                        class="img"
                        :src="isActive == ix ? it.iconActive : it.icon"
                    />
                    {{ it.name }}
                </p>
                <p></p>
...
export default {
    ...
    methods: {
        ...
        isData(val) {
            ...
            //导出excel
            if (val === "excel") {
                console.log(this.optionData.option,5555);
                let datas = {};
                let xAxis = [];
                let series = [];
                let bool = true;
                this.optionData.option.series.forEach((element,index) => {
                    series.push([])
                    if (element.type === "pie") {
                        console.log(series[index],element.type,this.optionData.option.series[index].data,888)
                        let list=[];
