...
export default [
	...
	},
	{
		...
		component: () => import(/* webpackChunkName: "energy" */ '@/pages/energy/children/accountsReceivable.vue'),
	},
	{
		path: 'gasWholesale',
		name: 'gasWholesale',
		component: () => import(/* webpackChunkName: "energy" */ '@/pages/energy/children/gasWholesale.vue'),
	},
	{
		path: 'gasRetail',
		name: 'gasRetail',
